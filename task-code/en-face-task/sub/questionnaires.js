...
var demo1 = {
  type: 'survey-text',
  questions: [
    {prompt: "What is your unique ID code (or Prolific ID)? This is just to help us identify you for credit assignment", required: true, name:'ID'},
    {prompt: "What is your age in years?", required: true, name:'age'},
    {prompt: "Please enter your date of birth, just month and year are perfectly fine", placeholder: "MM/YYYY", required: true, name:'dob'},
    {prompt: "Please indicate your marital status (Single, In a relationship, Married, Separated, Widowed, Other (if other please specify))", placeholder: "e.g., Single", required: true, name:'marital'},
    {prompt: "Please enter your first (native) language", placeholder: "English, French, Arabic, German, etc.", required: true, name:'natlang'},
    {prompt: "Please enter any additional languages that you speak in order of proficiency. For instance, if you speak French as your second language and a little bit of Spanish, please enter French, Spanish", placeholder: "e.g., French, Spanish", required: true, name:'olang'}
  ],
  preamble: '<br><font size="+2">Welcome! Here are some questions about your background. Please answer the following demographic questions as honestly as possible. All of your responses are strictly confidential</font>',
...
var health = {
  type: 'survey-text',
  questions: [
    {prompt: "If you have been diagnosed with a mental health condition over the past 6 months, please specify what kind of condition you have. If this does not apply to you, enter N/A.", placeholder: "e.g., Depressive Disorder, N/A", required: true, name:'mental'},
    {prompt: "Are you currently taking medication for a mental health treatment? If yes please specify the type. If this does not apply to you, enter N/A.", placeholder: "Antidepressants, N/A", required: true, name:'mentdrug'},
    {prompt: "If you are taking medication for a mental health treatment, please specify the drug name, frequency of use, and dosage. If this does not apply to you, enter N/A.", placeholder: "e.g., Sertraline, 15mg daily", required: true, name:'mentpos'}
  ],
  preamble: '<br><font size="+2">Thank you. Below are some questions about your physical and mental health along with any medication you have been or are currently taking. For any questions that do not apply to you, please enter "N/A". All of your responses are strictly confidential.</font>',
  on_finish: function(data){
...
var SSPC = {
  ...
  preamble: '<br><font size="+2">We are interested in what you think about politicians in <b>Canada</b>. Please indicate your thoughts about the following statements.',
      on_finish: function(data){
    jsPsych.data.addProperties({
...
var PAS = {
  ...
  questions: [
    ...
    {prompt: "Our country would be governed better if important decisions were left up to successful business people.", name:'pas_13', labels: pas, required:true},
    {prompt: "Our country would be governed better if important decisions were left up to independent experts.", name:'pas_14', labels: pas, required:true}
      ],
  preamble: '<br><font size="+2">Thanks! Here are some more questions on your political views. Again, we are interested in what you think about politicians in <b>Canada</b>. Please indicate your thoughts about the following statements.</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var CONTACT = {
  ...
  preamble: '<br><font size="+2">Here are some questions about your contact with people of <b>Middle-Eastern</b> geographic origin. Please indicate your level of agreement or your answer by clicking on it.</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var IDENTITY_NEEDS = {
  ...
  preamble: '<br><font size="+2">Thank you! Here are some more questions about your contact with people of <b>Middle-Eastern</b> geographic origin. Please indicate your level of agreement or your answer by clicking on it.</font>',
      on_finish: function(data){
    jsPsych.data.addProperties({
...
var A_DISC = {
  ...
  preamble: '<br><font size="+2">Thank you! Here are some more questions about what you discuss within your own group of origin regarding people of <b>Middle-Eastern</b> geographic origin. Please indicate your level of agreement or your answer by clicking on it.</font>',
      on_finish: function(data){
    jsPsych.data.addProperties({
...
var PLCSSJ = {
  ...
  preamble: '<br><font size="+2">Thank you! Here are some more questions asking you to indicate your level of agreement with some proposed statements concerning your thoughts about people of <b>Middle-Eastern</b> geographic origin. Please indicate your level of agreement or your answer by clicking on it.</font>',
      on_finish: function(data){
    jsPsych.data.addProperties({
...
var WIWOWP = {
  type: 'survey-likert',
  questions: [
    {prompt: "How willing are you to cooperate with people of Middle-Eastern geographic origin to work for justice for people of Middle-Eastern geographic origin?", name:'wwwp_01', labels: wwwp, required:true},
    {prompt: "How willing are you to protest alongside people of Middle-Eastern geographic origin to work for justice for people of Middle-Eastern geographic origin?", name:'wwwp_02', labels: wwwp, required:true},
    {prompt: "How willing are you to unite with people of Middle-Eastern geographic origin to work for justice for people of Middle-Eastern geographic origin?", name:'wwwp_03', labels: wwwp, required:true},
    {prompt: "Attending meetings or workshops regarding the unequal treatment of people of Middle-Eastern geographic origin.", name:'wwwp_04', labels: wwwp, required:true},
    {prompt: "Writing letters to public officials or other people of influence to protest against the unequal treatment of people of Middle-Eastern geographic origin.", name:'wwwp_05', labels: wwwp, required:true},
    {prompt: "Attending demonstrations, protests or rallies against the unequal treatment of people of Middle-Eastern geographic origin.", name:'wwwp_06', labels: wwwp, required:true},
    {prompt: "Voting for political candidates who support the equal treatment of people of Middle-Eastern geographic origin.", name:'wwwp_07', labels: wwwp, required:true},
    {prompt: "Signing an online/regular petition to support action against the unequal treatment of people of Middle-Eastern geographic origin.", name:'wwwp_08', labels: wwwp, required:true},
    {prompt: "Sharing posts on Facebook to support equality for people of Middle-Eastern geographic origin.", name:'wwwp_09', labels: wwwp, required:true}
    ],
  preamble: '<br><font size="+2">Thank you! Here are a last set of questions asking you to indicate your willigness to work with and advocate for people of <b>Middle-Eastern</b> geographic origin. Please indicate your level of agreement or your answer by clicking on it.</font>',
      on_finish: function(data){
    jsPsych.data.addProperties({
...
var SESincome = {
  ...
  preamble: '<br><font size="+2">For statistical purposes, we are interested in average incomes in Canadian Dollars. Please make your best guess, converting your own native currency to CAD. Some exchange rates are: 1 USD = 1.33 CAD, 1 AUS = 0.95 CAD, 1 EUR = 1.56 CAD, 1 GBP = 1.70 CAD</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var EDUC = {
  ...
  preamble: '<br><font size="+2">Here are some additional questions about your education background</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var demo2 = {
  ...
  questions: [
    ...
    {prompt: "Have you been diagnosed with a mental health condition over the past 6 months?", options: ['Yes', 'No'], name:'mental_check', required: true, horizontal: false,},
    ...
    preamble: '<font size="+2">Here are some more demographic questions that we will use for statistical purposes</font>',
    on_finish: function(data){
        jsPsych.data.addProperties({
...
var lsns_instruc = {
    type: 'instructions',
    pages: [
        '<p><font size="+2">You\'re doing great! These next two sets of questions are about your social interactions.</p></font>',
        ],
...
var lsns_fam = {
  ...
  preamble: '<font size="+2">Considering the people to whom you are <b>related</b> either by birth or marriage:</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var lsns_fri = {
  ...
  preamble: '<font size="+2">Considering all of your <b>friends</b> including those who live in your neighbourhood:</font>',
  on_finish: function(data){
    jsPsych.data.addProperties({
...
var questionnaires_pre = {
  timeline: [demo1, demo2, health, SESincome, EDUC],
};

var questionnaires_post = {
  timeline: [SSPC, PAS, CONTACT, IDENTITY_NEEDS, A_DISC, PLCSSJ, WIWOWP, lsns_instruc, lsns_fam, lsns_fri],
};
