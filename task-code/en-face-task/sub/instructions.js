// INSTRUCTIONS FOR PICC FACES TASK //
...
"<p>In this experiment, you will see a series of face images. </p>" +
"<p>The images will be presented on the screen one at a time. </p>" +
"<p>Your job in this study will be to identify bodies you think are <strong>of Middle-Eastern geographic origin</strong>.</p>",

"<p>When you see a face on the screen that you think is of Middle-Eastern geographic origin, press the <b>"+choicekeys[0].toUpperCase()+" key.</b></p>"+
"<p>For all other faces, press the <b>"+choicekeys[1].toUpperCase()+" key. </b></p>",

"<p>The faces will be presented in series with breaks in between. </p>"+
"<p>This means that you will see a series of faces, have a short break, and then another series of faces, until you have seen <strong>16 series.</strong></p>",

"<p>Some of the series you see may have a lot of faces of Middle-Eastern geographic origin, and others may have only a few.</p>" +
"<p>There is nothing for you to keep track of. Just make each choice as honestly as you can.</p>",

"<p>Please respond <strong>after</strong> you see each face. A <strong>?</strong> will appear when it is time to answer.</p>" +
...
"<p><strong>REMEMBER</strong>: Press <b>"+choicekeys[0].toUpperCase()+" </b>when you think the face is of Middle-Eastern geographic origin, and <b>"+choicekeys[1].toUpperCase()+" </b>if not. </p>"+
...
var end = {
	...
	stimulus: "<p>You have finished the main task!</p>"+
						...
						"<p>On the next screen, there will be just one more face to judge.</p>"+
...
var finish = {
  ...
  stimulus: "<p>You have finished the entire experiment!</p>"+
            "<p>You may now exit the window. Thanks for participating!</p>",
  choices: ['e']
};
